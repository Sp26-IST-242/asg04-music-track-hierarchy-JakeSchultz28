...
def main():
    ...
    morissette = Song(Artist("Alanis Morissette", "Alternative"),
           Album("Jagged Little Pill", False, list(range(1995,1996))),
           245)
    
    rogan = Podcast(Artist("Joe Rogan", "Comedy"),
           Album("The Joe Rogan Experience", True, list(range(2009,2010))),
           9000, True)
    
    koenig = Podcast(Artist("Sarah Koenig", "Journalism"),
